...
import {default as ResponseOrig, Seq, getSampleSchema, fromJSOrdered, stringify, getExampleComponent, cx, List, Map } from './swagger-ui/response';

export default class Response extends ResponseOrig{
  ...
  render() {
    ...
    let { inferSchema, oneOfPlugin } = fn
    ...
    if(isOAS3) {
      ...
      if(examplesForMediaType) {
        ...
        sampleResponse = getSampleSchema(fn, oas3SchemaForContentType.toJS(), this.state.responseContentType, {
    ...
    // Check for Potenital OneOf Schema
    let schemaParseConfig;
    if(isOAS3 && oneOfPlugin.matchContentType(activeContentType)) {
    ...
    return (
      ...
      <tr className={ "response " + ( className || "") } data-code={code}>
        ...
        <td className="col response-col_description">
          ...
          { schemaParseConfig && (example || schema) ? (
            <div>IIIIIIIIIII:::::
            <ModelExample
